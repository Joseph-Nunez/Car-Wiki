...
public class CWUserInterface extends JFrame {
    ...
    //Top: title + orange search bar + chained filter rows
    ...
    // Center: car spotlight (single result) + results table
    ...
    // Bottom: file load + CRUD + wishlist actions
    ...
    // Local AND-filter used only for the chained "+" rows (CarDatabase doesn't need to change for this)
    ...
    // Car's fields are int (topSpeed/horsepower), so this parses with Integer, not Double.
